...
class Student:
    ...
    def student_full_name(cls, full_name, roll_no):
        # variables de clase
        full_name = full_name
        return cls(full_name, '', roll_no)   # Llama al constructor de la clase
...
''' Sin crear objetos a que metodos puedo llamar??? '''
#Student.prueba()   # Error porque no tengo ninguna instancia
Student.get_student_rules()  # Acceso a los metodos estaticos
Student.student_full_name("Pepito",56)  # Acceso a los metodos de clase
